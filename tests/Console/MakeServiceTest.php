...
class MakeServiceTest extends TestCase
{
    ...
    {
        config()->set('devsi.paths.service.path', app_path('Services2'));
        config()->set('devsi.paths.service.namespace', "App\Services2");
    ...
    public function test_create_service_without_config_file()
    {
        ...
        config()->unset('devsi.paths.service.path');
        config()->unset('devsi.paths.service.namespace');
