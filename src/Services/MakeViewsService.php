...
namespace devsi\Crudy\Services;
...
class MakeViewsService
{
    ...
    public function createDirectoryViews($namingConvention): void
    {
     ...
     * @param $laravelNamespace
     * @return array|string
     */
    public function replaceContentControllerStub($namingConvention, $laravelNamespace): array|string
    {
    ...
    public function findAndReplaceControllerPlaceholderColumns($columns, $controllerStub, $namingConvention): array|string
    {
        $cols='';
    ...
    public function findAndReplaceIndexViewPlaceholderColumns($columns, $templateViewsDirectory, $namingConvention, $separateStyleAccordingToActions): array|string
    {
        $thIndex=$indexView='';
        foreach ($columns as $column)
        {
