...
class MakeApiControllerService
{
    ...
    public function replaceContentApiControllerStub($namingConvention, $laravelNamespace): array|string
    {
        ...
        return str_replace('DummyRootNamespace', $laravelNamespace, $controllerStub);
    }

    public function findAndReplaceApiControllerPlaceholderColumns($columns, $controllerStub, $namingConvention): array|string
    {
        $cols='';
        ...
        return str_replace('DummyCreateVariableSing$', '$'.$namingConvention['singular_low_name'], $controllerStub);
    }

    public function createApiControllerFile($pathNewController, $controllerStub, $namingConvention): void
    {
    ...
    public function makeCompleteApiControllerFile($namingConvention, $columns, $laravelNamespace): void
    {
